...
//haru - ignoreParentsOpacity 속성관련 추가
#define PROPERTY_IGNOREPARENTSOPACITY "ignoreParentsOpacity"

//haru - childrenOpacity 속성관련 추가
#define PROPERTY_ENABLECHILDRENOPACITY "enableChildrenOpacity"
#define PROPERTY_CHILDRENOPACITY "childrenOpacity"
...
class CCNodeLoader : public CCObject {
    public:
        ...
        virtual void parseProperties(CCNode * pNode, CCNode * pParent, CCBReader * pCCBReader); //jambam 원본
    ...
    protected:
        ...
        virtual CCSpriteFrame * parsePropTypeSpriteFrame(CCNode * pNode, CCNode * pParent, CCBReader * pCCBReader, const char *pPropertyName);    //jambam 원본
...
private:
    ...
    void ReplaceString( std::string & strSrc, const char * pszBefore, const char * pszAfter );
};
