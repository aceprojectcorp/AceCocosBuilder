...
public:
    ...
    CCNode** readNodeGraphFromFile(const char *pCCBFileName, CCObject *pOwner, int iArrayCnt);
    
    CCNode* readNodeGraphFromFile(const char *pCCBFileName, CCObject *pOwner, const CCSize &parentSize);
    CCNode** readNodeGraphFromFile(const char *pCCBFileName, CCObject *pOwner, const CCSize &parentSize, int iArrayCnt);
    ...
    //haru - 언어설정    
    void setLanguage(_LanguageType language) { m_language = language; }
    _LanguageType getLanguage() { return m_language; }
...
private:
    ...
    CCNode* readNodeGraph(CCNode * pParent); //jambam 원본
